...
export default function Help({data}:InferGetServerSidePropsType<typeof getStaticProps>) {
    ...
    return (
        <div className={styles.container}>
            ...
            <h2>このサイトの目的</h2>
            <div className={styles.subContainer}>
                <p>多目的に一緒にゲームを遊ぶ人について募集を行う場合、様々な媒体があります。</p>
                <p>募集掲示板とか、Twitterとか、Discodeのコミュニティでもよいでしょう。</p>
                <p>しかし、一緒に遊びたいけど相手は自分と同じ社会人が良いとか、プレイ時間帯の合う人が良いとか、</p>
                <p>細かく条件をつけ始めると、ただのフレンド募集掲示板では探すのにも苦労します。</p>
                <p>このサイトは、まず主たる募集の目的を登録する必要があります。</p>
                <p>それはタグではなく、予め決められた中から近いものを選んでもらうため、かんたんに検索することができます。</p>
                <p>これによって、たとえばPSO2ではアイテム取引やチームの立ち上げメンバーの募集、</p>
                <p>新人を歓迎する旨のチームの勧誘など具体的な募集が可能になります。</p>
