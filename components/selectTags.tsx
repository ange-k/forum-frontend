...
import { PostTagsEnum } from '../lib/gen/models/Post';
...
const SelectTags:React.FC<SelectTagsProps> = ({title, selected, selectTag, deleteTag}) => {
    ...
    return (
        <div>
            <div className={styles.item}>
                <div className={styles.taglabel} data-multiline="true" data-tip="最大5つのタグを紐付ける<br/>ことができます。">
